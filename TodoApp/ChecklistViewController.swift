...
class ChecklistViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "AddItemSegue" {
            if let addItemViewControler = segue.destination as? AddItemViewController {
                addItemViewControler.delegate = self
            }
        }
    }
}

extension ChecklistViewController: AddItemViewConrollerDelegate {
